...
class AlipaySubmit {
     ...
     * @return 要请求的参数数组
     */
    function buildRequestPara($para_temp, $needSort = true) {
        //除去待签名参数数组中的空值和签名参数
    ...
    function buildRequestUrl(array $params)
    {
        return $this->alipay_gateway_new . http_build_query($params);
    }
     ...
     * @return 提交表单HTML文本
     */
    function buildRequestForm($para_temp, $method, $button_name = '订单确认') {
        //待请求参数数组
        $para = $this->buildRequestPara($para_temp);
    ...
    <body>
        <table align="center" width="350" cellpadding="5" cellspacing="0">
            ...
            <tr>
                ...
                <td class="font_content" align="left">{$para_temp['out_trade_no']}</td>
            </tr>
            <tr>
                <td class="font_content" align="right">付款总金额：</td>
                <td class="font_content" align="left">{$para_temp['total_fee']}</td>
            </tr>
            <tr>
                <td align="center" colspan="2">{$sHtml}</td>
            </tr>
        </table>
    </body>
</html>
