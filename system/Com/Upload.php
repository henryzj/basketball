...
class Com_Upload
{
     ...
     * @return boolean
     */
    protected function _move(array $file, $name = null)
    {
        if (! $this->check($file)) {
            return false;
        }
     ...
     * @return boolean
     */
    public function checkInput($fileInputName)
    {
        return $this->check($this->_files[$fileInputName]);
    }

    public function getFinalSaveName($fileInputName)
    {
        return $this->setSaveName() . '.' . $this->getExt($this->_files[$fileInputName]['name']);
    }
     ...
     * @return boolean
     */
    public function isImage(array $file)
    {
     ...
     * @return boolean
     */
    public function checkType(array $file, $allowedTypes)
    {
     ...
     * @return boolean
     */
    public function checkExt(array $file, $allowedExts)
    {
     ...
     * @return boolean
     */
    public function checkFileSize(array $file, $maxSize)
    {
     ...
     * @return unknown
     */
    public function checkImageSize(array $file, $maxSize)
    {
