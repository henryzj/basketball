 ...
 * $Id: Client.php 9155 2014-02-24 18:32:30Z jiangjian $
 */
...
class Helper_Client
{
    ...
    {
        $bots = '/(bot|crawl|spider|slurp|yahoo|sohu-search|lycos|robozilla)/i';
        return preg_match($bots, strtolower($_SERVER['HTTP_USER_AGENT']));
    }
}